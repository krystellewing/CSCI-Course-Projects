...
def readDataFile(filename):
    '''
    This function returns lists formed from a csv file
...
def create_averages(category_list):
    ...
    Parameters: category_list 
        list of drought category lists
...
def main():
    ...
    for filename in ['az.csv','ca.csv','or.csv','tx.csv','pa.csv','me.csv']:
        state_list, drought_lists = readDataFile(filename)
        
    # Adds the averages into a comma separated list
    # Adds list as a key into an empty dictionary and state string as value
        new_list = []
        d = {}
        for categories in drought_lists:
        ...
        visualize_averages(state_list, d)
